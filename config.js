...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Pkdriller~hDNzFB5a#u_oBtjlaILUt-nDFyAtL79CgE4FQ1YK9fp2Hv6lUaGc",
// add your Session Id 
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot
BOT_NAME: process.env.BOT_NAME || "✦ YOINGT ✦ XMD ✦",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ✦ YOUNG TEE ✦*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://img2url.xdtools.id/5738b.png",
